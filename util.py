...
def rnnClassifier(source, modelSaveLocation):
	...
	model.add(LSTM(hidden_size,input_shape(1,128),return_sequences=True))
	model.add(LSTM(hidden_size,input_shape(1,128),return_sequences=True))
	model.add(LSTM(hidden_size,input_shape(1,128))	
